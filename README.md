...
Linter
Your repository should include an .eslintrc file, which you can find in the main lecture repository for your class.
...
Technical Boundaries
Your project should utilize and be focused upon the technologies you learned in Bootcamp I.
...
The content of Bootcamp I is the common point of tooling among your project team. Going outside of these boundaries can lead to inequities on your team. If your team can make a legitimate case to the instructional staff to bring in additional tooling, the team should learn any new tools together.

Why:

Working within a limited tool set on a project will amplify your engineering acumen and improve your depth of understanding with the tools.
...
You can use additive libraries like ChartJS or AnimateCSS.
...
File Structure
Before you scaffold your files within your repo, determine how you will organize your project. Your files should be organized into folders in a meaningful manner.

Use the file structure we have been using, but add folders for each page
...
Best practice is to delete your branch on Github because excessive branches lingering on GitHub can clutter your repository. If the branch is needed again, check it out locally, work on the branch, and it will reopen the branch on GitHub after you add, commit, and push the changes. For educational purposes we want you to keep your branches so you can reference your progress easily.
...
State is persisted between page reloads, and common state is used between at least two pages
